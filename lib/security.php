...
add_filter('script_loader_src', '\Evermade\Security\removeScriptVersion', 15, 1);
add_filter('style_loader_src', '\Evermade\Security\removeScriptVersion', 15, 1);
